...
const FamilyAssociationModal = ({ isOpen, onClose }) => {
    ...
    useEffect(() => {
        if (isOpen) {
            ...
            setSubmitted(false);
            setError('');
            setForm({ familyMemberName: '', familyMemberNif: '', familyMemberBirthDate: '', requesterMessage: '' });
        }
    }, [isOpen]);
    ...
    const fetchMyRequests = async () => {
        ...
        try {
            ...
            const res = await fetch(`${API_BASE}/api/family-associations/my-requests`, {
    ...
    return (
        <div className="fam-modal-overlay" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
            <div className="fam-modal">
                <div className="fam-modal-header">
                    <div className="fam-modal-title">
                        <FaUserFriends />
                        <h2>Associar Familiar</h2>
                    </div>
                    <button className="fam-modal-close" onClick={onClose}>
                        <FaTimes />
                    </button>
                </div>
                    ...
                    {!submitted ? (
                        <form onSubmit={handleSubmit} className="fam-form">
                            <p className="fam-form-description">
                                ...
                                O administrador irá processar o pedido.
                            </p>
                            ...
                            <div className="fam-form-group">
                                ...
                                <textarea
                                    ...
                                    placeholder="Informação adicional para o administrador..."
                                    rows={3}
                        ...
                        <div className="fam-success">
                            ...
                            <p>O administrador irá processar o teu pedido e fazer a associação via People Manager.</p>
                                    ...
                                    return (
                                        <div key={req.id} className="fam-history-item">
                                            <div className="fam-history-info">
                                                ...
                                                {req.familyMemberNif && <span className="fam-history-nif">NIF: {req.familyMemberNif}</span>}
...
export default FamilyAssociationModal;
