...
namespace CdpApi.Migrations
{
    ...
    [Migration("20260318093526_AllowDuplicateMembershipNumber")]
    partial class AllowDuplicateMembershipNumber
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CdpApi.Models.CoachTeam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CoachProfileId", "TeamId")
                        .IsUnique();

                    b.ToTable("CoachTeams");
                });

            modelBuilder.Entity("CdpApi.Models.Escalao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CdpApi.Models.EscalaoSport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CdpApi.Models.Event", b =>
                {
                    ...
                    b.Property<decimal?>("TicketPriceNonSocio")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("TicketPriceSocio")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("CdpApi.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 3, 18, 9, 35, 25, 182, DateTimeKind.Utc).AddTicks(9226),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 3, 18, 9, 35, 25, 182, DateTimeKind.Utc).AddTicks(9228),
            ...
            modelBuilder.Entity("CdpApi.Models.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CdpApi.Models.TrainingSchedule", b =>
                {
                    ...
                    b.Property<string>("DaySchedules")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CdpApi.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 3, 18, 9, 35, 25, 352, DateTimeKind.Utc).AddTicks(7513),
                            Email = "admin@cdp.com",
                            FirstName = "Admin",
                            Gender = 3,
                            IsActive = true,
                            LastName = "User",
                            PasswordHash = "$2a$11$hXnHk/FkJl2XBDYbTWFCwOcuOR0PWtGVLH9qfXdwPzX9EGFJnEqmi"
                        });
                });
            ...
            modelBuilder.Entity("CdpApi.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AssignedAt = new DateTime(2026, 3, 18, 9, 35, 25, 352, DateTimeKind.Utc).AddTicks(8107),
                            RoleId = 2,
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("CdpApi.Models.CoachTeam", b =>
                {
                    b.HasOne("CdpApi.Models.CoachProfile", "CoachProfile")
                        .WithMany("CoachTeams")
