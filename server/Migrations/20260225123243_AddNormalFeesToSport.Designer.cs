...
namespace CdpApi.Migrations
{
    ...
    [Migration("20260225123243_AddNormalFeesToSport")]
    partial class AddNormalFeesToSport
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CdpApi.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 2, 25, 12, 32, 43, 210, DateTimeKind.Utc).AddTicks(2637),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 2, 25, 12, 32, 43, 210, DateTimeKind.Utc).AddTicks(2639),
            ...
            modelBuilder.Entity("CdpApi.Models.Sport", b =>
                {
                    ...
                    b.Property<decimal>("FeeNormalSibling")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("CdpApi.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 2, 25, 12, 32, 43, 332, DateTimeKind.Utc).AddTicks(7839),
                            Email = "admin@cdp.com",
                            FirstName = "Admin",
                            IsActive = true,
                            LastName = "User",
                            PasswordHash = "$2a$11$OLbwsl.eZOtgk88hoRge5uXrui64wwgwk4ydRRY9WIkpGs9mBVp3u"
                        });
                });
            ...
            modelBuilder.Entity("CdpApi.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AssignedAt = new DateTime(2026, 2, 25, 12, 32, 43, 332, DateTimeKind.Utc).AddTicks(8292),
                            RoleId = 2,
                            UserId = 1
                        });
                });
