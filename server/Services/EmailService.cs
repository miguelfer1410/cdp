                            ...
                            <div style='max-width: 600px; margin: 0 auto; padding: 40px 20px;'>
                                <div style='background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 12px rgba(0,0,0,0.08);'>
                                    ...
                                    <div style='padding: 40px;'>
                                        ...
                                        <div style='text-align: center; margin: 35px 0;'>
                                            <a href='http://localhost:3001/dashboard/atleta' style='background: linear-gradient(135deg, #003380, #00509e); color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 1em; display: inline-block;'>
